    ...
    */
    ...
    describe('patch()', () => {
        it('returns a number of todos updated', async () => {
            ...
            testlab_1.expect(await controller.patch(aTodoListWithId.id, aTodoToPatchTo, where)).to.eql({ count: 1 });
            testlab_1.sinon.assert.calledWith(todos, aTodoListWithId.id);
    ...
    describe('deleteAll()', () => {
        it('returns a number of todos deleted', async () => {
            ...
            testlab_1.expect(await controller.delete(aTodoListWithId.id)).to.eql({
